...
export class MvFooterDemo extends LitElement {
  ...
  render() {
    const dark = "--mv-footer-background: #373E48;";
    return html`    
    <div class="content">
      <div class="theme">
        <mv-fa icon="lightbulb" style="color: ${this.open ? "yellow" : ""}" @click=${this.toggleLightBulb}></mv-fa>
      </div>
      <contained-footer-demo style="${!this.open ? dark : ""}"></contained-footer-demo>
    ...
    <mv-footer style="${!this.open ? dark : ""}">
...
customElements.define("mv-footer-demo", MvFooterDemo);
